...
function Faqs(props) {
    ...
    const data = [
        {
            title: "What is BetterHelp?",
            desc: "BetterHelp is the largest therapy platform in the world and it's 100% online. We change the way people approach their mental health and help them tackle life's challenges by providing accessible and affordable care. With BetterHelp, you can message a professional therapist anytime, anywhere.",
        },
        {
            ...
            desc:"The professionals who work through BetterHelp are registered therapists who hold the proper credentials to provide therapy. However, while the service may have similar benefits, it's not capable of substituting for traditional face-to-face therapy in every case. Please note that your therapist won't be able to make any official diagnosis, to fulfill any court order or prescribe medication."
        },{
            ...
            title: "Is BetterHelp web accessible for disabled users?",
            ...
            title: "How will I pay for my BetterHelp membership?",
            desc:"Your membership payments will be charged to a credit card or PayPal on a recurring basis. If you accomplish your goals or if you find therapy with BetterHelp to no longer be helpful for any reason, you can simply cancel the subscription."
        },{
            title: "Can I be reimbursed by my insurance?",
            desc:"Neither BetterHelp nor Therapists on the BetterHelp Platform submit claims to Medicare, Medicaid or health insurers. Services offered using this site are generally not covered by health insurance, Medicare or Medicaid.\n"
        },{
            ...
            title: "How can I get started with BetterHelp?",
            desc:"Click here to get started."
        },{
            title: "I'm a registered therapist. How can I provide services using BetterHelp?",
